...
export const getCategoryWithSubsYear = async (
  ...
  // Filtry spójne z Twoją logiką limitów:
  // - WYKLUCZAMY depozyty do kopert (depositEnvelopeId IS NULL)
  // - Domyślnie WYKLUCZAMY zakupy finansowane kopertą (financedEnvelopeId IS NULL), chyba że includeFinanced = true
  // - tylko WYDATKI (c.positive = 0)
  const finFilter = includeFinanced ? '' : 'AND e.financedEnvelopeId IS NULL';

  // 1) Miesięczne sumy kategorii
  ...
  // 2) Rozbicie na podkategorie (12 kolumn / pivot w kliencie)
